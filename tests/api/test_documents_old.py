...
class TestGenerateDocumentPreview:
    def test_generate_document_preview_success(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_document = Mock(spec=Document)
            mock_document.document_id = 1
            mock_document.order_id = 101
            mock_document.generated_at = datetime.now(timezone.utc)
            
            mock_service.return_value.generate_document_for_order.return_value = mock_document
    ...
    def test_generate_document_preview_order_not_found(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.generate_document_for_order.side_effect = RecordNotFoundError("Order 999 not found")
    ...
    def test_generate_document_preview_generation_error(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.generate_document_for_order.side_effect = DocumentGenerationServiceException("Template not found")
...
class TestGetDocumentPreview:
    def test_get_document_preview_success(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            ...
            try:
                mock_service.return_value.get_document_preview_path.return_value = mock_path
    ...
    def test_get_document_preview_document_not_found(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.get_document_preview_path.side_effect = RecordNotFoundError("Document 999 not found")
    ...
    def test_get_document_preview_file_not_found(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.get_document_preview_path.side_effect = FileNotFoundServiceException("Preview file not found")
...
class TestDownloadDocument:
    def test_download_document_success(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            ...
            try:
                mock_service.return_value.get_document_download_path.return_value = mock_path
    ...
    def test_download_document_invalid_token(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.get_document_download_path.side_effect = DocumentGenerationServiceException("Invalid access token")
    ...
    def test_download_document_expired_token(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.get_document_download_path.side_effect = DocumentGenerationServiceException("Access token has expired")
    ...
    def test_download_document_not_found(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.get_document_download_path.side_effect = RecordNotFoundError("Document 999 not found")
...
class TestGetDocument:
    def test_get_document_success(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            ...
            mock_service.return_value.get_document_by_id.return_value = mock_document
    ...
    def test_get_document_not_found(self):
        with patch("app.api.dependencies.get_document_service") as mock_service:
            mock_service.return_value.get_document_by_id.side_effect = RecordNotFoundError("Document 999 not found")
